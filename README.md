# :traffic_light: Real User Monitoring (RUM) Power Toy for Magento 2 by [JaJuMa](https://www.jajuma.de/)

<img align="right" width="35%" height="auto" src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-for-magento-2/JaJuMa-Real-User-Monitoring-RUM-Power-Toy-For-Magento-2-small.png">  

Real User Monitoring (RUM) Power Toy for Magento 2 by [JaJuMa](https://www.jajuma.de/en) is a dashboard toy 
showing the real user Monitoring status with Core Web Vitals and other KPIs in your Magento store based on [JaJuMa Real User Monitoring (RUM)](https://www.jajuma.de/en/jajuma-develop/magento-extensions/real-user-monitoring-rum-extension-for-magento-2).
...
* Core Web Vitals KPI (LCP, INP, CLS), each with 
  * current value & distribution for latest 28-days collection period
  * trend as change compared to 7 days ago
* Other Performance KPI (FCP, TTFB), each with
  * current value & distribution for latest 28-days collection period
  * trend as change compared to 7 days ago
* Cache Hit Rate for latest 28-days collection period + change compared to 7 days ago
* Error Rate for latest 28-days collection period + change compared to 7 days ago
...
<td>
    <table>
     <tr>
        <td><b>Real User Monitoring (RUM) Toy</b><br>Dark Mode</td>
        <td><b>Real User Monitoring (RUM) Toy</b><br>Light Mode</td>
     </tr>
     <tr>
       <td><img src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-for-magento-2/screenshots/Magento-Real-User-Monitoring-RUM-Power-Toy-Dark.jpg"></td>
       <td><img src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-for-magento-2/screenshots/Magento-Real-User-Monitoring-RUM-Power-Toy-Light.jpg"></td>
    </tr>
    </table>
</td>
...
* [Real User Monitoring (RUM)](https://www.jajuma.de/en/jajuma-develop/magento-extensions/real-user-monitoring-rum-extension-for-magento-2)
...
```
composer require jajuma/pot-rum
```

## Using Real User Monitoring (RUM) Power Toy For Magento

After installing this module:  
Go to   
**JaJuMa -> Power Toys -> Configuration**  
and enable & configure Real User Monitoring (RUM) Toy.  
...
displaying the Real User Monitoring (RUM) Toy.

* [See Manual for more details](https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-for-magento-2/manuals/JaJuMa_Real_User_Monitoring_Power_Toy_Manual_v001.pdf)
...
* :arrow_up_small: :free: UI & UX:<br>[Phosphor Hyvä for Hyvä Themes](https://www.jajuma.de/en/jajuma-develop/magento-extensions/phosphor-icons-for-hyva-themes-extension)<br>
  Phosphor Icons for your [Hyvä Themes](https://www.jajuma.de/de/jajuma-shop/online-shop-mit-magento-2-und-hyva-themes) Store
